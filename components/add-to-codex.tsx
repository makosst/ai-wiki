...
interface AddToCodexProps {
  apiKey?: string;
}

export function AddToCodex({ apiKey: serverApiKey }: AddToCodexProps) {
  ...
  const command = apiKey
    ? `codex mcp add aiwiki -- npx mcp-remote https://aiwiki.dev/api/mcp --header "AIWIKI_API_KEY: ${apiKey}"`
    : `codex mcp add aiwiki -- npx mcp-remote https://aiwiki.dev/api/mcp --header "AIWIKI_API_KEY: YOUR_API_KEY"`;
    ...
    <>
      <Button variant="secondary" size="sm" onClick={() => setIsOpen(true)}>
        <span className="flex items-center gap-2">
          Add to Codex
          <Image src="/codex.png" alt="Codex" width={16} height={16} className="inline-block" />
        </span>
      </Button>
              ...
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <CardTitle>Add AI Wiki to Codex</CardTitle>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="grid w-full items-center gap-1.5">
                    <Label htmlFor="codex-command">Command</Label>
                  ...
                  <div className="space-y-2 text-sm text-gray-700">
                    ...
                    <ul className="list-disc list-inside space-y-1 ml-2">
                      <li>Adds AI Wiki as an MCP server to Codex</li>
                      <li>Enables you to search and read AI Wiki content directly from Codex</li>
                  ...
                  <div className="space-y-2 text-sm text-gray-700">
                    ...
                    <ol className="list-decimal list-inside space-y-1 ml-2">
                      ...
                      <li>Restart Codex to activate the MCP server</li>
                    </ol>
                  </div>
                </div>
              </CardContent>
